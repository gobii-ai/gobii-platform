...
class AnalyticsEvent(StrEnum):
    ...
    OUTBOX_EMAIL_QUEUED = 'Outbox Email Queued'
    OUTBOX_EMAIL_EDITED = 'Outbox Email Edited'
    OUTBOX_EMAIL_APPROVED = 'Outbox Email Approved'
    OUTBOX_EMAIL_DISCARDED = 'Outbox Email Discarded'
    OUTBOX_EMAIL_EXPIRED = 'Outbox Email Expired'
    OUTBOX_EMAIL_FAILED = 'Outbox Email Failed'
    OUTBOX_EMAIL_RETRIED = 'Outbox Email Retried'
    OUTBOX_DELIVERY_BYPASS_DENIED = 'Outbox Delivery Bypass Denied'
    ...
    PAYMENT_SETUP_INTENT_SUCCEEDED = 'Payment SetupIntent Succeeded'
