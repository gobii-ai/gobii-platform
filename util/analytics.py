...
class AnalyticsEvent(StrEnum):
    ...
    PERSISTENT_AGENT_WORK_TASK_DAILY_LIMIT_REACHED = 'Persistent Agent Work Task Daily Limit Reached'
    ...
    PERSISTENT_AGENT_WORK_TASK_CREATED = 'Persistent Agent Work Task Created'
    PERSISTENT_AGENT_WORK_TASK_COMPLETED = 'Persistent Agent Work Task Completed'
    PERSISTENT_AGENT_WORK_TASK_FAILED = 'Persistent Agent Work Task Failed'
    PERSISTENT_AGENT_WORK_TASK_CANCELLED = 'Persistent Agent Work Task Cancelled'
