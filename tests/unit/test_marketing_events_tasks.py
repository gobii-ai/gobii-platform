...
class MarketingEventsTaskTests(SimpleTestCase):
    ...
    @patch("marketing_events.tasks.Analytics.track")
    @patch("marketing_events.tasks._cancel_at_period_end_from_db", return_value=None)
    @patch("marketing_events.tasks._cancel_at_period_end_from_stripe", return_value=True)
    def test_enqueue_start_trial_skips_when_cancel_at_period_end(
        ...
        self.assertEqual(track_kwargs["properties"]["reason"], "cancel_at_period_end")
    ...
    @patch("marketing_events.tasks._dispatch_marketing_event")
    @patch("marketing_events.tasks.Analytics.track")
    @patch("marketing_events.tasks._cancel_at_period_end_from_db", return_value=False)
    @patch("marketing_events.tasks._cancel_at_period_end_from_stripe", return_value=None)
