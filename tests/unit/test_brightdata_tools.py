...
class BrightDataNativeToolTests(SimpleTestCase):
    def test_tool_definitions_match_brightdata_mcp_parameters(self):
        ...
        self.assertIn("API or data URL", search["description"])
        self.assertIn("search_tools('HTTP API request') once", search["description"])
        self.assertIn("Never browse or scrape", search["description"])
