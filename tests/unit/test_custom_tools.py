...
"""
    ...
    def test_create_custom_tool_definition_mentions_direct_tool_and_sqlite_access(self):
        ...
        self.assertEqual(definition["function"]["name"], "create_custom_tool")
        self.assertIn("source_path", properties)
        self.assertIn("source_code", properties)
        self.assertIn("parameters_schema", properties)
        self.assertIn("source_path", definition["function"]["parameters"]["required"])
