...
1,Alice"""
    ...
    def test_scrape_as_markdown_preview_uses_plain_markdown_and_meta_guidance(self):
        ...
        self.assertIn("result_id-keyed bound rows array", prompt_info.meta)
        self.assertIn("sqlite_batch's `rows` argument", prompt_info.meta)
        self.assertIn("Always store result_id", prompt_info.meta)
        self.assertIn("exact known page URL", prompt_info.meta)
