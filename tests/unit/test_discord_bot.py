...
class NativeDiscordBotTests(TestCase):
    ...
    def test_inbound_reply_context_is_persisted_and_rendered_for_agent(
        ...
        self.assertIn('"name":"Version"', user_prompt)
    ...
    def test_inbound_embed_only_message_is_readable_in_agent_prompt(
        ...
        self.assertIn('"name":"Release Bot"', user_prompt)
        self.assertIn('"name":"Status Service"', user_prompt)
        self.assertIn('"name":"Version","value":"v42","inline":true', user_prompt)
        self.assertIn('"thumbnailUrl":"https://status.example.test/icon.png"', user_prompt)
