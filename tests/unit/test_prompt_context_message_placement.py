...
class PromptContextSqlitePlacementTests(TestCase):
    ...
    def test_sqlite_guidance_only_in_system_message(self):
        ...
        self.assertIn("link other record names to item/detail URLs", system_message["content"])
        ...
        self.assertIn("separate sourced unavailability from unresearched gaps", system_message["content"])
