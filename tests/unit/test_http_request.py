...
class HttpRequestJsonParsingTests(TestCase):
    ...
    def test_tool_definition_routes_known_endpoints_directly(self):
        ...
        self.assertIn("generic, unverified, mismatched, or unqualified recipient", tool["description"])
        self.assertIn("fixed offset and never satisfies a named zone", tool["description"])
