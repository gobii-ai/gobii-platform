...
class SolutionView(TemplateView):
    ...
    DEDICATED_TEMPLATES = {
        ...
        'small-business': 'solutions/small_business.html',
    ...
    SOLUTION_DATA = {
        ...
        'small-business': {
            ...
            'tagline': 'Delegate the recurring work that keeps spilling after hours.',
            'description': 'Use Gobii AI coworkers for lead research, customer follow-up, vendor checks, data cleanup, local visibility, and weekly owner briefings.',
            'seo_title': 'AI Coworkers for Small Business | Gobii',
            'seo_description': 'Delegate lead research, customer follow-up, vendor checks, data cleanup, and recurring browser work to always-on Gobii AI coworkers built for small businesses.',
            'date_modified': '2026-06-10',
            'social_image': 'images/solutions/sales-hero.jpg',
            'social_image_alt': 'Gobii AI coworkers helping a small business with browser research and owner briefings',
        },
        'health-care': {
            'title': 'Health Care',
