...
from pages.public_template_urls import (
    public_template_category_slug, public_template_category_slug_aliases_from_label, public_template_category_slug_from_label, public_template_detail_path, public_template_route_slug,
)
