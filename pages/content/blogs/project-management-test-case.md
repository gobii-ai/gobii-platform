...
<img src="/static/images/blog/horus-intro@0.5x.png" style="display: inline-block; float: right; text-align: right; width: 350px; margin-left: 5px; margin-bottom: 5px;  box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5);"  alt="Horus's Intro Email for AI Project Management"/>
