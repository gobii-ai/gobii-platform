...
# ────────── Native Telegram Managed Bots ──────────
TELEGRAM_MANAGER_BOT_TOKEN = env("TELEGRAM_MANAGER_BOT_TOKEN", default="")
TELEGRAM_MANAGER_BOT_USERNAME = env("TELEGRAM_MANAGER_BOT_USERNAME", default="")
TELEGRAM_MANAGER_WEBHOOK_SECRET = env("TELEGRAM_MANAGER_WEBHOOK_SECRET", default="")
TELEGRAM_INBOUND_DEBOUNCE_SECONDS = env.int("TELEGRAM_INBOUND_DEBOUNCE_SECONDS", default=15)
