...
SANDBOX_TRANSPARENT_PROXY_POD_IMAGE = env(
    "SANDBOX_TRANSPARENT_PROXY_POD_IMAGE",
    default="ghcr.io/gobii-ai/gobii-sandbox-traffic-proxy:main",
)
SANDBOX_TRANSPARENT_PROXY_PORT = env.int("SANDBOX_TRANSPARENT_PROXY_PORT", default=15001)
