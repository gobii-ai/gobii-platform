...
STRIPE_LIVE_SECRET_FALLBACK = os.environ.get(
    "STRIPE_LIVE_SECRET_KEY", "<your default live env secret key>"
)
STRIPE_TEST_SECRET_FALLBACK = os.environ.get(
    "STRIPE_TEST_SECRET_KEY", "<your default test env secret key>"
)
STRIPE_LIVE_SECRET_KEY = STRIPE_LIVE_SECRET_FALLBACK
STRIPE_TEST_SECRET_KEY = STRIPE_TEST_SECRET_FALLBACK
