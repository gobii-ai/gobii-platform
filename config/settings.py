...
SANDBOX_COMPUTE_WORKSPACE_VOLUME_MODE = env("SANDBOX_COMPUTE_WORKSPACE_VOLUME_MODE", default="pvc")
SANDBOX_COMPUTE_WORKSPACE_EMPTYDIR_SIZE = env(
    "SANDBOX_COMPUTE_WORKSPACE_EMPTYDIR_SIZE",
    default=SANDBOX_COMPUTE_PVC_SIZE,
)
SANDBOX_COMPUTE_SNAPSHOT_CLASS = env("SANDBOX_COMPUTE_SNAPSHOT_CLASS", default="")
SANDBOX_COMPUTE_SNAPSHOT_ON_IDLE_STOP = env.bool("SANDBOX_COMPUTE_SNAPSHOT_ON_IDLE_STOP", default=True)
