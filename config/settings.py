...
MCP_ASYNC_TASKS_ENABLED = env.bool("MCP_ASYNC_TASKS_ENABLED", default=True)
MCP_ASYNC_TASK_MAX_LIFETIME_SECONDS = env.int("MCP_ASYNC_TASK_MAX_LIFETIME_SECONDS", default=3600)
MCP_ASYNC_TASK_MAX_ACTIVE_PER_AGENT = env.int("MCP_ASYNC_TASK_MAX_ACTIVE_PER_AGENT", default=10)
MCP_ASYNC_TASK_MIN_POLL_INTERVAL_SECONDS = env.int(
    "MCP_ASYNC_TASK_MIN_POLL_INTERVAL_SECONDS",
    default=2,
)
MCP_ASYNC_TASK_MAX_POLL_INTERVAL_SECONDS = env.int(
    "MCP_ASYNC_TASK_MAX_POLL_INTERVAL_SECONDS",
    default=60,
)
MCP_ASYNC_TASK_LEASE_SECONDS = env.int("MCP_ASYNC_TASK_LEASE_SECONDS", default=120)
MCP_ASYNC_TASK_RECONCILE_BATCH_SIZE = env.int("MCP_ASYNC_TASK_RECONCILE_BATCH_SIZE", default=100)
...
MAX_PARALLEL_TOOL_CALLS = env.int("MAX_PARALLEL_TOOL_CALLS", default=6)
...
BROWSER_SESSION_TICKET_TTL_SECONDS = env.int(
    "BROWSER_SESSION_TICKET_TTL_SECONDS",
    default=60,
)
BROWSER_SESSION_TICKET_SESSION_TTL_SECONDS = env.int(
    "BROWSER_SESSION_TICKET_SESSION_TTL_SECONDS",
    default=3600,
)
...
PUBLIC_ALTERNATIVETO_URL = env(
    "PUBLIC_ALTERNATIVETO_URL",
    default=_proprietary_default("brand", "PUBLIC_ALTERNATIVETO_URL"),
)
...
PUBLIC_MEDIUM_URL = env(
    "PUBLIC_MEDIUM_URL",
    default=_proprietary_default("brand", "PUBLIC_MEDIUM_URL"),
)
...
PA_RAW_MSG_LIMIT = env.int("PA_RAW_MSG_LIMIT", default=20)
PA_COMMS_COMPACTION_TAIL = env.int("PA_COMMS_COMPACTION_TAIL", default=5)
PA_RAW_STEP_LIMIT = env.int("PA_RAW_STEP_LIMIT", default=100)
PA_STEP_COMPACTION_TAIL = env.int("PA_STEP_COMPACTION_TAIL", default=10)
PA_HISTORY_COMPACTION_LEASE_SECONDS = env.int(
    "PA_HISTORY_COMPACTION_LEASE_SECONDS",
    default=3600,
)
AGENT_INTERACTIVE_MAX_LOOP_ITERATIONS = env.int("AGENT_INTERACTIVE_MAX_LOOP_ITERATIONS", default=10)
AGENT_INTERACTIVE_MAX_RUNTIME_SECONDS = env.int(
    "AGENT_INTERACTIVE_MAX_RUNTIME_SECONDS",
    default=300,
)
AGENT_INTERACTIVE_MAX_ITERATIONS_FOLLOWUP_DELAY_SECONDS = env.int(
    "AGENT_INTERACTIVE_MAX_ITERATIONS_FOLLOWUP_DELAY_SECONDS",
    default=0,
)
...
AGENT_OWNER_CUSTOM_INSTRUCTIONS_MAX_CHARS = env.int(
    "AGENT_OWNER_CUSTOM_INSTRUCTIONS_MAX_CHARS",
    default=env.int("ORGANIZATION_CUSTOM_INSTRUCTIONS_MAX_CHARS", default=16000),
)
ORGANIZATION_CUSTOM_INSTRUCTIONS_MAX_CHARS = AGENT_OWNER_CUSTOM_INSTRUCTIONS_MAX_CHARS
...
COMPUTER_CPP_PAIRING_TTL_SECONDS = env.int("COMPUTER_CPP_PAIRING_TTL_SECONDS", default=600)
COMPUTER_CPP_PAIRING_POLL_INTERVAL_SECONDS = env.int(
    "COMPUTER_CPP_PAIRING_POLL_INTERVAL_SECONDS",
    default=5,
)
COMPUTER_CPP_ACCESS_TOKEN_TTL_SECONDS = env.int("COMPUTER_CPP_ACCESS_TOKEN_TTL_SECONDS", default=600)
COMPUTER_CPP_REFRESH_TOKEN_TTL_SECONDS = env.int(
    "COMPUTER_CPP_REFRESH_TOKEN_TTL_SECONDS",
    default=90 * 24 * 60 * 60,
)
COMPUTER_CPP_PRESENCE_TTL_SECONDS = env.int("COMPUTER_CPP_PRESENCE_TTL_SECONDS", default=60)
COMPUTER_CPP_HELLO_TIMEOUT_SECONDS = env.int("COMPUTER_CPP_HELLO_TIMEOUT_SECONDS", default=10)
COMPUTER_CPP_REQUEST_TIMEOUT_SECONDS = env.int("COMPUTER_CPP_REQUEST_TIMEOUT_SECONDS", default=90)
COMPUTER_CPP_MAX_FRAME_BYTES = env.int("COMPUTER_CPP_MAX_FRAME_BYTES", default=256 * 1024)
COMPUTER_CPP_MAX_ARTIFACT_BYTES = env.int("COMPUTER_CPP_MAX_ARTIFACT_BYTES", default=8 * 1024 * 1024)
COMPUTER_CPP_ARTIFACT_TTL_SECONDS = env.int("COMPUTER_CPP_ARTIFACT_TTL_SECONDS", default=900)
COMPUTER_CPP_PAIRING_STARTS_PER_IP_HOUR = env.int(
    "COMPUTER_CPP_PAIRING_STARTS_PER_IP_HOUR",
    default=10,
)
COMPUTER_CPP_CODE_ATTEMPTS_PER_PAIRING_USER = env.int(
    "COMPUTER_CPP_CODE_ATTEMPTS_PER_PAIRING_USER",
    default=10,
)
COMPUTER_CPP_REFRESHES_PER_DEVICE_HOUR = env.int(
    "COMPUTER_CPP_REFRESHES_PER_DEVICE_HOUR",
    default=60,
)
...
CAPI_START_TRIAL_CONV_RATE = env.float("CAPI_START_TRIAL_CONV_RATE", default=0.322)
CAPI_START_TRIAL_SCALE_CONV_RATE = env.float("CAPI_START_TRIAL_SCALE_CONV_RATE", default=0.22)
...
BRIGHT_DATA_TOKEN = env("BRIGHT_DATA_TOKEN", default="")
BRIGHT_DATA_SERP_ZONE = env("BRIGHT_DATA_SERP_ZONE", default="")
BRIGHT_DATA_WEB_UNLOCKER_ZONE = env("BRIGHT_DATA_WEB_UNLOCKER_ZONE", default="")
BRIGHT_DATA_WEB_UNLOCKER_ZONE_FALLBACK = env("BRIGHT_DATA_WEB_UNLOCKER_ZONE_FALLBACK", default="")
BRIGHT_DATA_REQUEST_TIMEOUT_SECONDS = env.float("BRIGHT_DATA_REQUEST_TIMEOUT_SECONDS", default=300.0)
BRIGHT_DATA_SEARCH_REQUEST_TIMEOUT_SECONDS = env.float(
    "BRIGHT_DATA_SEARCH_REQUEST_TIMEOUT_SECONDS",
    default=10.0,
)
BRIGHT_DATA_DATASET_POLL_TIMEOUT_SECONDS = env.float(
    "BRIGHT_DATA_DATASET_POLL_TIMEOUT_SECONDS",
    default=600.0,
)
...
SANDBOX_SQLITE_SYNC_MODE = env(
    "SANDBOX_SQLITE_SYNC_MODE",
    default="snapshot",
)
SANDBOX_SQLITE_RSYNC_BINARY = env(
    "SANDBOX_SQLITE_RSYNC_BINARY",
    default="/usr/local/bin/sqlite3_rsync",
)
SANDBOX_SQLITE_RSYNC_TRANSPORT = env(
    "SANDBOX_SQLITE_RSYNC_TRANSPORT",
    default="/app/api/services/sqlite_rsync_ssh.py",
)
SANDBOX_SQLITE_RSYNC_TIMEOUT_SECONDS = env.int(
    "SANDBOX_SQLITE_RSYNC_TIMEOUT_SECONDS",
    default=180,
)
...
SANDBOX_COMPUTE_POD_CPU_REQUEST = env(
    "SANDBOX_COMPUTE_POD_CPU_REQUEST",
    default="500m",
)
SANDBOX_COMPUTE_POD_MEMORY_REQUEST = env(
    "SANDBOX_COMPUTE_POD_MEMORY_REQUEST",
    default="1Gi",
)
SANDBOX_COMPUTE_POD_CPU_LIMIT = env(
    "SANDBOX_COMPUTE_POD_CPU_LIMIT",
    default="2",
)
SANDBOX_COMPUTE_POD_MEMORY_LIMIT = env(
    "SANDBOX_COMPUTE_POD_MEMORY_LIMIT",
    default="4Gi",
)
SANDBOX_COMPUTE_POD_EPHEMERAL_STORAGE_REQUEST = env(
    "SANDBOX_COMPUTE_POD_EPHEMERAL_STORAGE_REQUEST",
    default="",
)
SANDBOX_COMPUTE_POD_EPHEMERAL_STORAGE_LIMIT = env(
    "SANDBOX_COMPUTE_POD_EPHEMERAL_STORAGE_LIMIT",
    default="",
)
...
SANDBOX_EGRESS_PROXY_POD_CPU_REQUEST = env(
    "SANDBOX_EGRESS_PROXY_POD_CPU_REQUEST",
    default="50m",
)
SANDBOX_EGRESS_PROXY_POD_MEMORY_REQUEST = env(
    "SANDBOX_EGRESS_PROXY_POD_MEMORY_REQUEST",
    default="64Mi",
)
SANDBOX_EGRESS_PROXY_POD_CPU_LIMIT = env(
    "SANDBOX_EGRESS_PROXY_POD_CPU_LIMIT",
    default="250m",
)
SANDBOX_EGRESS_PROXY_POD_MEMORY_LIMIT = env(
    "SANDBOX_EGRESS_PROXY_POD_MEMORY_LIMIT",
    default="256Mi",
)
...
SANDBOX_COMPUTE_SERVICE_ROUTABLE_TIMEOUT_SECONDS = env.int(
    "SANDBOX_COMPUTE_SERVICE_ROUTABLE_TIMEOUT_SECONDS",
    default=60,
)
...
SANDBOX_COMPUTE_WORKSPACE_VOLUME_MODE = env("SANDBOX_COMPUTE_WORKSPACE_VOLUME_MODE", default="emptydir")
SANDBOX_COMPUTE_WORKSPACE_EMPTYDIR_SIZE = env(
    "SANDBOX_COMPUTE_WORKSPACE_EMPTYDIR_SIZE",
    default="1Gi",
)
SANDBOX_COMPUTE_SNAPSHOT_CLASS = env("SANDBOX_COMPUTE_SNAPSHOT_CLASS", default="")
SANDBOX_COMPUTE_SNAPSHOT_ON_IDLE_STOP = env.bool("SANDBOX_COMPUTE_SNAPSHOT_ON_IDLE_STOP", default=False)
...
SANDBOX_COMPUTE_RECONCILE_TERMINAL_SESSIONS = env.bool(
    "SANDBOX_COMPUTE_RECONCILE_TERMINAL_SESSIONS",
    default=False,
)
SANDBOX_COMPUTE_TERMINAL_RECONCILE_GRACE_SECONDS = env.int(
    "SANDBOX_COMPUTE_TERMINAL_RECONCILE_GRACE_SECONDS",
    default=900,
)
SANDBOX_COMPUTE_TERMINAL_RECONCILE_LIMIT = env.int(
    "SANDBOX_COMPUTE_TERMINAL_RECONCILE_LIMIT",
    default=50,
)
SANDBOX_COMPUTE_RECONCILE_DELETE_WORKSPACES = env.bool(
    "SANDBOX_COMPUTE_RECONCILE_DELETE_WORKSPACES",
    default=False,
)
SANDBOX_COMPUTE_RECONCILE_DELETE_SNAPSHOTS = env.bool(
    "SANDBOX_COMPUTE_RECONCILE_DELETE_SNAPSHOTS",
    default=False,
)
...
DISCORD_BOT_INVITE_PERMISSIONS = env.int("DISCORD_BOT_INVITE_PERMISSIONS", default=536939584)
DISCORD_INBOUND_DEBOUNCE_SECONDS = env.int(
    "DISCORD_INBOUND_DEBOUNCE_SECONDS",
    default=env.int("PIPEDREAM_DISCORD_INBOUND_DEBOUNCE_SECONDS", default=5),
)
DISCORD_WEBHOOK_MAX_TOTAL_ATTACHMENT_BYTES = env.int(
    "DISCORD_WEBHOOK_MAX_TOTAL_ATTACHMENT_BYTES",
    default=8 * 1024 * 1024,
)
...
FINGERPRINT_SERVER_API_URL = (
    env.str("FINGERPRINT_SERVER_API_URL", default="https://api.fpjs.io").strip() or "https://api.fpjs.io"
)
FINGERPRINT_SERVER_API_KEY = env.str("FINGERPRINT_SERVER_API_KEY", default="").strip()
FINGERPRINT_SERVER_API_TIMEOUT_SECONDS = env.int("FINGERPRINT_SERVER_API_TIMEOUT_SECONDS", default=10)
FINGERPRINT_SERVER_PROCESSING_STALE_SECONDS = env.int(
    "FINGERPRINT_SERVER_PROCESSING_STALE_SECONDS",
    default=900,
)
