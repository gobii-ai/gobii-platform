...
NATIVE_APP_ACCESS_TOKEN_TTL_SECONDS = env.int(
    "NATIVE_APP_ACCESS_TOKEN_TTL_SECONDS",
    default=3600,
)
NATIVE_APP_REFRESH_TOKEN_TTL_SECONDS = env.int(
    "NATIVE_APP_REFRESH_TOKEN_TTL_SECONDS",
    default=2592000,
)
