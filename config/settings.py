...
FINGERPRINT_SERVER_API_URL = env.str("FINGERPRINT_SERVER_API_URL", default="https://api.fpjs.io")
FINGERPRINT_SERVER_API_KEY = env.str("FINGERPRINT_SERVER_API_KEY", default="")
