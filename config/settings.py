...
# ────────── Agent Credit Forecast Samples ──────────
AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_ENABLED = env.bool(
    "AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_ENABLED",
    default=False,
)
AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_LIMIT = env.int(
    "AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_LIMIT",
    default=5000,
)
AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_BATCH_SIZE = env.int(
    "AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_BATCH_SIZE",
    default=100,
)
AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_GENERATE_EMBEDDINGS = env.bool(
    "AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_GENERATE_EMBEDDINGS",
    default=True,
)
AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_SKIP_EXISTING_EMBEDDINGS = env.bool(
    "AGENT_CREDIT_FORECAST_SAMPLE_REFRESH_SKIP_EXISTING_EMBEDDINGS",
    default=True,
)
