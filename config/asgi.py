...
from console.agent_audit.consumers import StaffAgentDeveloperConsumer  # noqa: E402  pylint: disable=wrong-import-position
...
websocket_urlpatterns = [
    ...
    path("ws/staff/agents/<uuid:agent_id>/developer/", StaffAgentDeveloperConsumer.as_asgi()),
