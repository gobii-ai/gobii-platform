...
urlpatterns = [
    ...
    path("console/agents/<uuid:pk>/chat/settings/", PersistentAgentChatShellView.as_view(), name="agent_chat_shell_settings"),
    ...
    path("console/api/agents/<uuid:agent_id>/templates/share-info/", AgentTemplateShareInfoAPIView.as_view(), name="console_agent_template_share_info"),
