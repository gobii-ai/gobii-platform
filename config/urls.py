...
from console.api_views import (
    ...
    ImageGenerationEndpointPoolsAPIView,
...
urlpatterns = [
    ...
    path("console/api/llm/image-generations/endpoint-pools/", ImageGenerationEndpointPoolsAPIView.as_view(), name="console_llm_image_generation_endpoint_pools"),
