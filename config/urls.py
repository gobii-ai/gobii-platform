...
from console.views import (
    ...
    ContactRequestApproveView,
    ContactRequestDenyView,
    ContactRequestBulkApproveView,
    ContactRequestBulkDenyView,
    AgentAllowlistView,
...
urlpatterns = [
    ...
    path("console/contact-requests/<str:token>/approve/", ContactRequestApproveView.as_view(), name="contact_request_approve"),
    path("console/contact-requests/<str:token>/deny/", ContactRequestDenyView.as_view(), name="contact_request_deny"),
    path("console/contact-requests/bulk/<str:token>/approve-all/", ContactRequestBulkApproveView.as_view(), name="contact_request_approve_all"),
    path("console/contact-requests/bulk/<str:token>/deny-all/", ContactRequestBulkDenyView.as_view(), name="contact_request_deny_all"),
