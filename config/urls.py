...
from console.api_views import (
    ...
    DatabaseEndpointListCreateAPIView,
    DatabaseEndpointDetailAPIView,
    DatabaseTierListCreateAPIView,
    DatabaseTierDetailAPIView,
    DatabaseTierEndpointListCreateAPIView,
    DatabaseTierEndpointDetailAPIView,
...
urlpatterns = [
    ...
    path("console/api/llm/database/endpoints/", DatabaseEndpointListCreateAPIView.as_view(), name="console_llm_database_endpoints"),
    path("console/api/llm/database/endpoints/<uuid:endpoint_id>/", DatabaseEndpointDetailAPIView.as_view(), name="console_llm_database_endpoint_detail"),
    path("console/api/llm/database/tiers/", DatabaseTierListCreateAPIView.as_view(), name="console_llm_database_tiers"),
    path("console/api/llm/database/tiers/<uuid:tier_id>/", DatabaseTierDetailAPIView.as_view(), name="console_llm_database_tier_detail"),
    path("console/api/llm/database/tiers/<uuid:tier_id>/endpoints/", DatabaseTierEndpointListCreateAPIView.as_view(), name="console_llm_database_tier_endpoints"),
    path("console/api/llm/database/tier-endpoints/<uuid:tier_endpoint_id>/", DatabaseTierEndpointDetailAPIView.as_view(), name="console_llm_database_tier_endpoint_detail"),
