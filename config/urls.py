...
from console.api_views import (
    ...
    AppSupportRequestAPIView,
    ProductAnnouncementListAPIView,
    ProductAnnouncementReadAPIView,
    BillingInitialDataAPIView,
    ...
    StaffOrgDetailAPIView,
    StaffUserEmailVerifyAPIView,
    StaffUserEmailTriggerAPIView,
    StaffUserTaskCreditGrantAPIView,
    StaffOrgTaskCreditGrantAPIView,
    StaffUserSystemMessageAPIView,
    StaffOrgSystemMessageAPIView,
    StaffUserProcessEventsAPIView,
    StaffOrgProcessEventsAPIView,
    MCPServerListAPIView,
    MCPServerDetailAPIView,
    MCPServerTestAPIView,
    PlatformMCPServerListAPIView,
...
urlpatterns = [
    ...
    path("console/api/agent-messages/search/", AgentMessageSearchAPIView.as_view(), name="console_agent_message_search"),
    ...
    path("console/api/user/email/", UserEmailAPIView.as_view(), name="console_user_email"),
    path("console/api/staff/users/search/", StaffUserSearchAPIView.as_view(), name="staff-user-search"),
    path("console/api/staff/agents/<uuid:agent_id>/developer/export/", StaffAgentDeveloperExportAPIView.as_view(), name="console_agent_developer_export"),
    path("console/api/staff/agents/<uuid:agent_id>/developer/process/", StaffAgentProcessEventsAPIView.as_view(), name="console_agent_developer_process"),
    path("console/api/staff/agents/<uuid:agent_id>/developer/judge/", StaffAgentRunJudgeAPIView.as_view(), name="console_agent_developer_judge"),
    path(
        "console/api/staff/agents/<uuid:agent_id>/developer/judge-suggestions/<uuid:suggestion_id>/decision/",
        StaffAgentJudgeSuggestionDecisionAPIView.as_view(),
        name="console_agent_developer_judge_suggestion_decision",
    ),
