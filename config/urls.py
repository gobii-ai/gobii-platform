...
from console.api_views import (
    ...
    MCPOAuthStartView,
    MCPOAuthStatusView,
    MCPRemoteAuthAuthorizeView,
    MCPRemoteAuthStartView,
    MCPRemoteAuthStatusView,
...
urlpatterns = [
    ...
    path("console/api/mcp/remote-auth/start/", MCPRemoteAuthStartView.as_view(), name="console-mcp-remote-auth-start"),
    path(
        "console/api/mcp/remote-auth/status/<str:session_id>/",
        MCPRemoteAuthStatusView.as_view(),
        name="console-mcp-remote-auth-status",
    ),
    path("console/api/mcp/remote-auth/authorize/", MCPRemoteAuthAuthorizeView.as_view(), name="console-mcp-remote-auth-authorize"),
