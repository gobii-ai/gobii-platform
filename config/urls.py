...
from console.api_views import (
    ...
    VideoGenerationEndpointListCreateAPIView,
    VideoGenerationEndpointDetailAPIView,
    VideoGenerationTierListCreateAPIView,
    VideoGenerationTierDetailAPIView,
    VideoGenerationTierEndpointListCreateAPIView,
    VideoGenerationTierEndpointDetailAPIView,
...
urlpatterns = [
    ...
    # Video Generation
    path("console/api/llm/video-generations/endpoints/", VideoGenerationEndpointListCreateAPIView.as_view(), name="console_llm_video_generation_endpoints"),
    path("console/api/llm/video-generations/endpoints/<uuid:endpoint_id>/", VideoGenerationEndpointDetailAPIView.as_view(), name="console_llm_video_generation_endpoint_detail"),
    path("console/api/llm/video-generations/tiers/", VideoGenerationTierListCreateAPIView.as_view(), name="console_llm_video_generation_tiers"),
    path("console/api/llm/video-generations/tiers/<uuid:tier_id>/", VideoGenerationTierDetailAPIView.as_view(), name="console_llm_video_generation_tier_detail"),
    path("console/api/llm/video-generations/tiers/<uuid:tier_id>/endpoints/", VideoGenerationTierEndpointListCreateAPIView.as_view(), name="console_llm_video_generation_tier_endpoints"),
    path("console/api/llm/video-generations/tier-endpoints/<uuid:tier_endpoint_id>/", VideoGenerationTierEndpointDetailAPIView.as_view(), name="console_llm_video_generation_tier_endpoint_detail"),
