...
from console.api_views import (
    ...
    SummarizationEndpointListCreateAPIView,
    SummarizationEndpointDetailAPIView,
    SummarizationTierListCreateAPIView,
    SummarizationTierDetailAPIView,
    SummarizationTierEndpointListCreateAPIView,
    SummarizationTierEndpointDetailAPIView,
...
urlpatterns = [
    ...
    path("console/api/llm/summarization/endpoints/", SummarizationEndpointListCreateAPIView.as_view(), name="console_llm_summarization_endpoints"),
    path("console/api/llm/summarization/endpoints/<uuid:endpoint_id>/", SummarizationEndpointDetailAPIView.as_view(), name="console_llm_summarization_endpoint_detail"),
    path("console/api/llm/summarization/tiers/", SummarizationTierListCreateAPIView.as_view(), name="console_llm_summarization_tiers"),
    path("console/api/llm/summarization/tiers/<uuid:tier_id>/", SummarizationTierDetailAPIView.as_view(), name="console_llm_summarization_tier_detail"),
    path("console/api/llm/summarization/tiers/<uuid:tier_id>/endpoints/", SummarizationTierEndpointListCreateAPIView.as_view(), name="console_llm_summarization_tier_endpoints"),
    path("console/api/llm/summarization/tier-endpoints/<uuid:tier_endpoint_id>/", SummarizationTierEndpointDetailAPIView.as_view(), name="console_llm_summarization_tier_endpoint_detail"),
