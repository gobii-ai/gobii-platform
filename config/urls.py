...
urlpatterns = [
    ...
    path("console/agents/<uuid:pk>/secrets/edit/<str:secret_key>/", AgentSecretsEditView.as_view(), name="agent_secrets_edit"),
    path("console/agents/<uuid:pk>/secrets/edit/<str:secret_key>/form/", AgentSecretsEditFormView.as_view(), name="agent_secrets_edit_form"),
    path("console/agents/<uuid:pk>/secrets/delete/<str:secret_key>/", AgentSecretsDeleteView.as_view(), name="agent_secrets_delete"),
