...
from console.api_views import (
    ...
    WorkTaskEndpointListCreateAPIView,
    WorkTaskEndpointDetailAPIView,
    WorkTaskTierListCreateAPIView,
    WorkTaskTierDetailAPIView,
    WorkTaskTierEndpointListCreateAPIView,
    WorkTaskTierEndpointDetailAPIView,
...
urlpatterns = [
    ...
    path("console/api/llm/work-tasks/endpoints/", WorkTaskEndpointListCreateAPIView.as_view(), name="console_llm_work_task_endpoints"),
    path("console/api/llm/work-tasks/endpoints/<uuid:endpoint_id>/", WorkTaskEndpointDetailAPIView.as_view(), name="console_llm_work_task_endpoint_detail"),
    path("console/api/llm/work-tasks/tiers/", WorkTaskTierListCreateAPIView.as_view(), name="console_llm_work_task_tiers"),
    path("console/api/llm/work-tasks/tiers/<uuid:tier_id>/", WorkTaskTierDetailAPIView.as_view(), name="console_llm_work_task_tier_detail"),
    path("console/api/llm/work-tasks/tiers/<uuid:tier_id>/endpoints/", WorkTaskTierEndpointListCreateAPIView.as_view(), name="console_llm_work_task_tier_endpoints"),
    path("console/api/llm/work-tasks/tier-endpoints/<uuid:tier_endpoint_id>/", WorkTaskTierEndpointDetailAPIView.as_view(), name="console_llm_work_task_tier_endpoint_detail"),
