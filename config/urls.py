...
from console.api_views import (
    ...
    AgentVoiceRealtimeSessionAPIView,
    AgentVoiceTurnCreateAPIView,
    ...
    RealtimeVoiceEndpointListCreateAPIView,
    RealtimeVoiceEndpointDetailAPIView,
...
urlpatterns = [
    ...
    path("console/api/agents/<uuid:agent_id>/voice/realtime-session/", AgentVoiceRealtimeSessionAPIView.as_view(), name="console_agent_voice_realtime_session"),
    path("console/api/agents/<uuid:agent_id>/voice/turns/", AgentVoiceTurnCreateAPIView.as_view(), name="console_agent_voice_turn_create"),
    path(
    ...
    path("console/api/llm/realtime-voice/endpoints/", RealtimeVoiceEndpointListCreateAPIView.as_view(), name="console_llm_realtime_voice_endpoints"),
    path("console/api/llm/realtime-voice/endpoints/<uuid:endpoint_id>/", RealtimeVoiceEndpointDetailAPIView.as_view(), name="console_llm_realtime_voice_endpoint_detail"),
