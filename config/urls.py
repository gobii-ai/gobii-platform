...
from config.account_views import AccountAuthPopupCompleteView, AccountLoginModalView, AccountSignupModalView, PasswordResetBridgeConfirmView, PasswordResetBridgeContinueView, PasswordResetBridgeStartView
from console.api_views import ConsolePersistentAgentViewSet, AgentFsNodeDownloadAPIView, SignedAgentFsNodeDownloadAPIView, AgentFsNodeBulkDeleteAPIView, AgentFsNodeCreateDirAPIView, AgentFsNodeListAPIView, AgentFsNodeMoveAPIView, AgentFsNodeUploadAPIView, AgentMessageCopyAPIView, AgentMessageCreateAPIView, AgentMessageReportIssueAPIView, AgentLatestMessageReadAPIView, AgentHumanInputRequestBatchResponseAPIView, AgentHumanInputRequestDismissAPIView, AgentHumanInputRequestResponseAPIView, AgentPlanningSkipAPIView, AgentContactRequestListAPIView, AgentContactRequestResolveAPIView, AgentChatRosterAPIView, AgentQuickCreateAPIView, AgentSpawnIntentAPIView, AgentSuggestionsAPIView, AgentProcessingStatusAPIView, AgentStopAPIView, AgentAddonsAPIView, AgentSettingsAPIView, AgentQuickSettingsAPIView, AgentTemplateCloneAPIView, AgentSmsDisableAPIView, AgentSmsEnableAPIView, AgentTimelineAPIView, AgentSpawnRequestDecisionAPIView, AgentRequestedSecretsFulfillAPIView, AgentRequestedSecretsRemoveAPIView, UserProfileAPIView, UserPreferencesAPIView, UserPhoneAPIView, UserPhoneCancelAPIView, UserPhoneResendAPIView, UserPhoneVerifyAPIView, UserEmailResendVerificationAPIView, AgentWebSessionEndAPIView, AgentWebSessionHeartbeatAPIView, AgentWebSessionStartAPIView, AppSupportRequestAPIView, ProductAnnouncementListAPIView, ProductAnnouncementReadAPIView, BillingInitialDataAPIView, ConsoleSessionAPIView, SystemStatusAPIView, SystemSettingsListAPIView, SystemSettingDetailAPIView, StaffAgentSearchAPIView, StaffUserSearchAPIView, StaffUserDetailAPIView, StaffOrgDetailAPIView, StaffUserEmailVerifyAPIView, StaffUserEmailTriggerAPIView, StaffUserTaskCreditGrantAPIView, StaffOrgTaskCreditGrantAPIView, StaffUserSystemMessageAPIView, StaffOrgSystemMessageAPIView, StaffUserProcessEventsAPIView, StaffOrgProcessEventsAPIView, MCPServerListAPIView, MCPServerDetailAPIView, MCPServerTestAPIView, PlatformMCPServerListAPIView, PlatformMCPServerDetailAPIView, PlatformMCPServerTestAPIView, MCPServerAssignmentsAPIView, MCPOAuthCallbackView, MCPOAuthMetadataProxyView, MCPOAuthRevokeView, MCPOAuthSessionVerifierView, MCPOAuthStartView, MCPOAuthStatusView, AgentEmailOAuthCallbackView, AgentEmailOAuthRevokeView, AgentEmailOAuthSessionVerifierView, AgentEmailOAuthStartView, AgentEmailOAuthStatusView, StaffAgentAuditAPIView, StaffAgentAuditExportAPIView, StaffAgentAuditTimelineAPIView, StaffAgentJudgeSuggestionDecisionAPIView, StaffAgentProcessEventsAPIView, StaffAgentRunJudgeAPIView, StaffAgentSystemMessageAPIView, StaffAgentSystemMessageDetailAPIView, StaffPromptArchiveAPIView
from console.evals.api_views import EvalRunCompareAPIView, EvalRunDetailAPIView, EvalSuiteListAPIView, EvalSuiteRunCompareAPIView, EvalSuiteRunCreateAPIView, EvalSuiteRunDetailAPIView, EvalSuiteRunListAPIView, EvalSuiteRunRunTypeAPIView, GlobalSkillEvalLauncherAPIView, GlobalSkillEvalRunCreateAPIView
from console.pipedream_apps_api import AgentPipedreamAppAPIView, AgentPipedreamAppsAPIView, AgentPipedreamAppConnectAPIView, AgentPipedreamAppConnectionAPIView, PipedreamAppAgentConnectionsAPIView, PipedreamAppsAPIView, PipedreamAppSearchAPIView
...
from console.native_integrations_api import NativeIntegrationCallbackAPIView, NativeIntegrationAgentEventAPIView, NativeIntegrationConnectAPIView, NativeIntegrationFilesAPIView, NativeIntegrationListAPIView, NativeIntegrationPickerTokenAPIView, NativeIntegrationRevokeAPIView
...
from console.discord_api import AgentDiscordAppView, AgentDiscordChannelsView, AgentDiscordConnectView, AgentDiscordSubscriptionsView, DiscordDisconnectView, DiscordOAuthCallbackView, DiscordOAuthStartView
...
from console.views import BillingPortalView, ConsoleStatusView, LegacyConsoleStatusRedirectView, SystemSettingsView, ConsoleLLMConfigView, PlatformMCPServerManagementView, MCPOAuthCallbackPageView, AgentEmailOAuthCallbackPageView, NativeIntegrationOAuthCallbackPageView, AgentAvatarProxyView, AgentAvatarThumbnailProxyView, PublicAgentAvatarThumbnailView, AgentQuickSpawnView, AgentDailyLimitEmailActionView, AgentDeleteView, ConsoleEvalsView, ConsoleEvalsDetailView, StaffAgentAuditView, StaffUsersView, AgentContactRequestsView, AgentTransferInviteRespondAPIView, AgentAllowlistInviteAcceptView, AgentAllowlistInviteRejectView, AgentCollaboratorInviteAcceptAPIView, AgentCollaboratorInviteAcceptView, AgentCollaboratorInviteDeclineAPIView, AgentCollaboratorInviteRejectView, OrganizationInviteAcceptAPIView, OrganizationInviteAcceptView, OrganizationInviteRejectView, OrganizationInviteRevokeOrgView, OrganizationInviteResendOrgView, OrganizationMemberRemoveOrgView, OrganizationLeaveOrgView, OrganizationMemberRoleUpdateOrgView, OrganizationSeatPortalView, update_task_pack_quantity, update_contact_pack_quantity, update_addons, add_dedicated_ip_quantity, remove_dedicated_ip, remove_all_dedicated_ip, update_billing_settings, get_billing_settings, get_user_plan_api, cancel_subscription, sync_billing_subscription_state, resume_subscription, grant_credits, console_billing_update
from console.context_views import OrganizationCreateAPIView, SwitchContextView
from console.organization_api_views import CurrentOrganizationAPIView, CurrentOrganizationInviteAPIView, CurrentOrganizationInviteDetailAPIView, CurrentOrganizationInviteResendAPIView, CurrentOrganizationMemberAPIView, CurrentOrganizationTemplateAPIView, CurrentOrganizationTemplateDetailAPIView, CurrentOrganizationTemplateLaunchAPIView
...
urlpatterns = [
    ...
    path("staff/orgs/<uuid:org_id>/", StaffUsersView.as_view(), name="staff-org-detail"),
    ...
    path("console/billing/", LegacyConsoleRedirectView.as_view(), name="billing"),
    ...
    path("console/agents/<uuid:pk>/chat/email/", LegacyConsoleRedirectView.as_view(), name="agent_chat_shell_email"),
    path("console/agents/<uuid:pk>/chat/files/", LegacyConsoleRedirectView.as_view(), name="agent_chat_shell_files"),
    path("console/agents/<uuid:pk>/chat/contact-requests/", LegacyConsoleRedirectView.as_view(), name="agent_chat_shell_contact_requests"),
    ...
    path(
        "console/api/agents/<uuid:agent_id>/requested-secrets/fulfill/",
        AgentRequestedSecretsFulfillAPIView.as_view(),
        name="console_agent_requested_secrets_fulfill",
    ),
    path(
    ...
    path(
        ...
        AgentContactRequestResolveAPIView.as_view(),
        name="console_agent_contact_requests_resolve",
    ),
    ...
    path(
        ...
        AgentMessageReportIssueAPIView.as_view(),
        name="console_agent_message_report_issue",
    ),
    path("console/api/agents/<uuid:agent_id>/messages/latest/read/", AgentLatestMessageReadAPIView.as_view(), name="console_agent_latest_message_read"),
    ...
    path(
        "console/api/staff/agents/<uuid:agent_id>/audit/judge-suggestions/<uuid:suggestion_id>/decision/",
        StaffAgentJudgeSuggestionDecisionAPIView.as_view(),
        name="console_agent_audit_judge_suggestion_decision",
    ),
    ...
    path("console/api/staff/orgs/<uuid:org_id>/", StaffOrgDetailAPIView.as_view(), name="staff-org-detail-api"),
    path("console/api/staff/users/<int:user_id>/email/verify/", StaffUserEmailVerifyAPIView.as_view(), name="staff-user-email-verify"),
    path("console/api/staff/users/<int:user_id>/user-emails/<int:user_email_id>/send/", StaffUserEmailTriggerAPIView.as_view(), name="staff-user-email-trigger-send"),
    ...
    path("console/api/staff/orgs/<uuid:org_id>/task-credits/", StaffOrgTaskCreditGrantAPIView.as_view(), name="staff-org-task-credit-grant"),
    path("console/api/staff/users/<int:user_id>/system-messages/", StaffUserSystemMessageAPIView.as_view(), name="staff-user-system-message"),
    path("console/api/staff/orgs/<uuid:org_id>/system-messages/", StaffOrgSystemMessageAPIView.as_view(), name="staff-org-system-message"),
    path("console/api/staff/users/<int:user_id>/process-events/", StaffUserProcessEventsAPIView.as_view(), name="staff-user-process-events"),
    path("console/api/staff/orgs/<uuid:org_id>/process-events/", StaffOrgProcessEventsAPIView.as_view(), name="staff-org-process-events"),
    path("console/api/llm/", include("console.llm_urls")),
    ...
    path("console/api/staff/mcp/servers/", PlatformMCPServerListAPIView.as_view(), name="staff-platform-mcp-server-list"),
    ...
    path("console/agents/<uuid:pk>/email/", LegacyConsoleRedirectView.as_view(), name="agent_email_settings"),
    path("console/agents/<uuid:pk>/files/", LegacyConsoleRedirectView.as_view(), name="agent_files"),
    path("console/agents/<uuid:pk>/contact-requests/", AgentContactRequestsView.as_view(), name="agent_contact_requests"),
    path(
        "console/api/agent-transfer-invites/<uuid:invite_id>/accept/",
        AgentTransferInviteRespondAPIView.as_view(),
        {"action": "accept"},
        name="console-agent-transfer-invite-accept-api",
    ),
    path(
        "console/api/agent-transfer-invites/<uuid:invite_id>/decline/",
        AgentTransferInviteRespondAPIView.as_view(),
        {"action": "decline"},
        name="console-agent-transfer-invite-decline-api",
    ),
    ...
    path("console/organizations/", LegacyConsoleRedirectView.as_view(), name="organizations"),
    path("console/organizations/add/", LegacyConsoleRedirectView.as_view(), name="organization_add"),
    path("console/organizations/<uuid:org_id>/", LegacyConsoleRedirectView.as_view(), name="organization_detail"),
    path("console/api/organizations/invites/<str:token>/accept/", OrganizationInviteAcceptAPIView.as_view(), name="console-org-invite-accept-api"),
    ...
    path('billing/settings/sync-subscription-state/', sync_billing_subscription_state, name='sync_billing_subscription_state'),
