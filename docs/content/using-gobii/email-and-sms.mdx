...
Use [Review Before Send](/using-gobii/review-before-send) when external email should wait in Outbox for a human to inspect, edit, approve, or discard the exact message before delivery. Contact access remains a separate requirement.
...
- Use Review Before Send for external sends when the Gobii is new or the content is sensitive.
