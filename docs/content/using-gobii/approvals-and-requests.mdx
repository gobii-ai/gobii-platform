...
| Outbox review | Gobii prepared external email that must be reviewed before delivery. |
...
<Screenshot
  ...
  alt="Meta Gobii timeline showing a pending approval request before creating a three-Gobii recruiting team."
  caption="Approval requests keep important changes explicit. Review the scope, then approve, revise, or narrow the instruction in chat."
/>
...
## Outbox email reviews

When a Gobii's external email policy requires review, the email waits in Outbox until an authorized person approves or discards the exact version. Review the complete recipient list, subject, body, attachments, and warnings before approving. Email approval does not grant contact access.

See [Review Before Send](/using-gobii/review-before-send) for policy options, editing, notifications, expiry, and failed-delivery retries.
