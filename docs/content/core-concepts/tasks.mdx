...
Tasks consume **task credits** from your account. Most tasks cost a fraction of a credit — the base cost per task is **0.05 credits**, and most individual tool calls (searches, scrapes, API calls, messages) fall in this range.
...
|---|---|---|---|
| **Standard** (1×) | 1.00 | 0.05 credits | Routine tasks, simple lookups |
| **Smarter** (2×) | 2.00 | 0.10 credits | Research, multi-step workflows |
| **Smartest** (5×) | 5.00 | 0.25 credits | Complex analysis, deep research |
| **Ultra** (20×) | 20.00 | 1.00 credits | Maximum capability |
| **Ultra Max** (50×) | 50.00 | 2.50 credits | Peak performance |
...
**Example:** On the Standard tier, sending an email costs ~0.05 credits. On Smartest (5×), the same email costs ~0.25 credits — still fractional, but proportional to the intelligence boost.
