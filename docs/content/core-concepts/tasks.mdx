...
Tasks consume **task credits** from your account. Most tasks cost a fraction of a credit, and most individual tool calls (searches, scrapes, API calls, messages) fall in this range.
...
Your agent's intelligence level affects how capable your agent is and how quickly it consumes credits:

| Tier | Best for |
|---|---|
| **Standard** | Routine tasks, simple lookups |
| **Premium** | Research, multi-step workflows |
| **Max** | Complex analysis, deep research |
| **Ultra** | Maximum capability |
| **Ultra Max** | Peak performance |

Higher tiers give your agent access to more capable models and deeper reasoning, but they consume credits faster — top tiers can cost many times more per task. You set the intelligence level per agent in the agent settings.
