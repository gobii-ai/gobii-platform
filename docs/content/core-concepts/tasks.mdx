...
Tasks consume **task credits** from your account. The cost varies by task type and complexity:

- A simple email send might cost ~0.04 credits
- A web search or page scrape might cost ~2–3 credits
- A complex browser automation could cost more
...
Each agent has a **daily soft limit** on task credits. This prevents runaway consumption. The agent will pause when it hits the limit and resume the next day.
...
- **Chat timeline**: Watch tasks execute in real time as your agent works
