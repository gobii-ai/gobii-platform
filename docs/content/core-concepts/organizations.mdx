...
MCP servers configured for the org must be explicitly assigned to agents before they can be used. Unassigned org agents cannot access org-level MCP servers. See [Organization MCP Servers](/admin-and-teams/organization-mcp-servers).
