...
2. Find the **Dedicated IPs** section
3. Select an available IP from the dropdown (the dropdown only appears when IPs are provisioned on your account)
4. Save your changes
...
- [Browser tasks](/developers/developer-tasks) — see dedicated IPs in action with browser automation
