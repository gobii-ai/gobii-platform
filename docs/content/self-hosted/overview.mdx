...
1. Set `BRIGHT_DATA_TOKEN` in your deployment environment. Native search and markdown scraping also require `BRIGHT_DATA_WEB_UNLOCKER_ZONE`; LinkedIn person profiles require only the token.
