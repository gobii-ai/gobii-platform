...
To move agents from another Gobii deployment into this installation, use the portable [Import Agents](/using-gobii/import-agents) wizard. The open-source build enables it by default.
