...
export type ProviderEndpoint = {
  ...
  type: 'persistent' | 'browser' | 'embedding' | 'file_handler' | 'work_task'
  low_latency?: boolean
  enabled: boolean
  provider_id: string
}
...
export type EndpointChoices = {
  ...
  work_task_endpoints: ProviderEndpoint[]
}
...
const endpointPaths = {
  ...
  work_task: `${base}/work-tasks/endpoints/`,
} as const
...
export function createWorkTaskTier(payload: { description?: string }) {
  return jsonRequest(`${base}/work-tasks/tiers/`, withCsrf(payload))
}

export function updateWorkTaskTier(tierId: string, payload: Record<string, unknown>) {
  return jsonRequest(`${base}/work-tasks/tiers/${tierId}/`, withCsrf(payload, 'PATCH'))
}

export function deleteWorkTaskTier(tierId: string) {
  return jsonRequest(`${base}/work-tasks/tiers/${tierId}/`, withCsrf(undefined, 'DELETE'))
}

export function addWorkTaskTierEndpoint(tierId: string, payload: { endpoint_id: string; weight: number }) {
  return jsonRequest(`${base}/work-tasks/tiers/${tierId}/endpoints/`, withCsrf(payload))
}

export function updateWorkTaskTierEndpoint(tierEndpointId: string, payload: Record<string, unknown>) {
  return jsonRequest(`${base}/work-tasks/tier-endpoints/${tierEndpointId}/`, withCsrf(payload, 'PATCH'))
}

export function deleteWorkTaskTierEndpoint(tierEndpointId: string) {
  return jsonRequest(`${base}/work-tasks/tier-endpoints/${tierEndpointId}/`, withCsrf(undefined, 'DELETE'))
}
