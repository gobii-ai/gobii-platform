...
type NativeWorkingTabKind = 'google_drive' | 'apollo' | 'hubspot' | 'discord' | 'meta_ads' | 'computer' | 'gmail' | 'outlook'
...
export const AgentComposer = memo(function AgentComposer({
  ...
  const nativeTabAvailability = useMemo(
    ...
    [apolloTabAvailable, computerTabAvailable, discordTabAvailable, gmailTabAvailable, googleDriveTabAvailable, hubspotTabAvailable, metaAdsTabAvailable, outlookTabAvailable],
  )
