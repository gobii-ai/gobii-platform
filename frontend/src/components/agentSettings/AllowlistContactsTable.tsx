...
import {
  EmbeddedRemoveButton, EmbeddedStatusBadge, EmbeddedTableFrame, EmbeddedTableHeader, embeddedBulkBannerClassName, embeddedBulkButtonClassName, embeddedTableBodyClassName, embeddedTableHeadClassName,
