import type {
  AgentErrorStatusSection, AgentProcessingStatusSection, BrowserTaskStatusSection, CeleryStatusSection, ComputeStatusSection, ProxyStatusSection, SystemStatusPayload, WebSessionStatusSection,
