...
from pages.views import (
    AboutView, CareersView, ComparisonDetailView, ComparisonsIndexView, DataDeletionPolicyView, PrivacyPolicyView, ScaleCheckoutView, StartupCheckoutView, TeamView, TermsOfServiceView,
)
