...
class DailyCreditConfigAdmin(admin.ModelAdmin):
    ...
    def _apply_default_daily_credit_target_to_matching_agents(
        self,
        previous_config,
        ...
        for agent in agents:
            ...
            plan_name, plan_version_id = self._owner_plan_identifiers(owner)
            if not self._config_applies_to_owner(
                previous_config,
                previous_settings_map,
                plan_name=plan_name,
            ...
            old_default_limit = self._default_limit_from_payload(
                old_payload,
                plan_name=plan_name,
                tier_multiplier=tier_multiplier,
            )
            ...
            new_default_limit = self._default_limit_from_payload(
                new_payload,
                plan_name=plan_name,
                tier_multiplier=tier_multiplier,
            )
    ...
    def save_model(self, request, obj, form, change):
        ...
        updated_count = self._apply_default_daily_credit_target_to_matching_agents(
            previous_config,
            previous_settings_map,
        )
        if updated_count:
