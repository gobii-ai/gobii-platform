...
class PersistentAgentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'user__email', 'organization__name', 'charter', 'mini_description')
    ...
    readonly_fields = (
        ...
        'mini_description', 'mini_description_charter_hash', 'mini_description_requested_hash',
    )
    inlines = [
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': (
                ...
                'charter', 'mini_description', 'mini_description_charter_hash',
                'mini_description_requested_hash', 'created_at', 'updated_at',
            )
        }),
        ('Configuration', {
            'fields': (
