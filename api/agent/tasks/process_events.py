...
@shared_task(bind=True, name="api.agent.tasks.process_connected_app_inbound_debounce")
def process_connected_app_inbound_debounce_task(
    self,
    persistent_agent_id: str,
    app_slug: str,
) -> None:  # noqa: D401, ANN001
    """Wake an agent after connected-app inbound messages have been quiet long enough."""
    from api.services.pipedream_trigger_subscriptions import process_connected_app_inbound_debounce

    process_connected_app_inbound_debounce(persistent_agent_id, app_slug)
