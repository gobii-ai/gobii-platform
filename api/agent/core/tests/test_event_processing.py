...
class ContinuationModePromptContextTests(TestCase):
    ...
    def test_prompt_includes_human_communication_style_guidance(self):
        ...
        self.assertIn("## Communication and output", system_prompt)
        self.assertIn("Be natural and direct", system_prompt)
        self.assertIn("cut filler, hype, repetition, and invented experience", system_prompt)
        self.assertIn("Preserve the user's voice", system_prompt)
        self.assertIn("Keep simple answers simple", system_prompt)
