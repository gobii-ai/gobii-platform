    ...
    prompt = [
        {
            ...
            "content": (
                ...
                "unresolved work. Copy opaque values such as identifiers, URLs, paths, timestamps, credentials, status "
                "tokens, and assignment IDs verbatim; never alter their case, punctuation, spacing, or characters. "
                "Preserve still-operative scoped directives—including ownership changes, handoffs, "
                ...
                "state with the newest explicit correction; never mention replaced values, even to explain the correction. "
                ...
                "mechanics unless they constrain current work. State active prohibitions explicitly; never weaken forbidden "
                "work into pending, unknown, or not-yet-done work. The summary must be at most 2,000 characters. Preserve "
                "who said, requested, observed, or changed each retained item and its source "
                "channel. Never transfer a statement to another person; keep uncertain attribution explicit. Before "
