...
CUSTOM_TOOL_DEVELOPMENT_SYSTEM_SKILL = SystemSkillDefinition(
    ...
    prompt_instructions=(
        ...
        "Before the first `create_custom_tool` call, check the draft for common rejections: exact final line "
        "`if __name__ == '__main__': main(run)`; `parameters_schema.required` requires real source inputs plus "
        ...
        "Use `from _gobii_ctx import main` and define `def run(params, ctx): ...`.\n"
