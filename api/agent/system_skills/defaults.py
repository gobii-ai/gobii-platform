...
META_GOBII_SYSTEM_SKILL = SystemSkillDefinition(
    ...
    prompt_instructions=(
        ...
        "Peer messaging boundary: meta_gobii_send_agent_message is a control-plane message injector, not a peer DM. "
        "When this invoking Gobii shares an enabled peer link with the target, use send_agent_message for questions, "
        "handoffs, replies, status updates, and ongoing coordination. After linking this Gobii to another Gobii with "
        "meta_gobii_link_agents, use the newly available send_agent_message tool for the follow-up message. Use "
        "meta_gobii_send_agent_message only when the invoking Gobii is not a linked endpoint and must brief or task an "
        "accessible Gobii from the control plane.\n"
