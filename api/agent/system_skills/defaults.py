...
RUNTIME_PLANNING_SYSTEM_SKILL = SystemSkillDefinition(
    ...
    prompt_instructions=(
        ...
        "The tool also accepts optional top-level `explanation`, `files`, and `messages` deliverables. Deliverables are associated with the whole current plan, not individual steps.\n"
