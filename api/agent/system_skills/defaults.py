...
CUSTOM_TOOL_DEVELOPMENT_SYSTEM_SKILL = SystemSkillDefinition(
    ...
    prompt_instructions=(
        ...
        "2. Invoke it with a small sample whose correct result is obvious.\n"
        "3. If it fails or returns the wrong result, apply_patch to that source and invoke it again. Do not call "
        "create_custom_tool again after registration; retry creation only if rejected.\n"
