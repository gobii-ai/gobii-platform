...
def _google_sheets_native_prompt_instructions(agent) -> str:
    ...
    return (
        ...
        "simpler legacy color fields unless you specifically need themed colors.\n"
...
def _apollo_native_prompt_instructions(agent) -> str:
    ...
    return (
        ...
        "Use documented Apollo endpoints exactly. For people search, use `/mixed_people/api_search`, not "
        "`/mixed_people` or `/mixed_people/search`. For usage, use `/usage_stats/api_usage_stats`, not "
