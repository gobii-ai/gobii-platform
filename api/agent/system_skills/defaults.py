...
RUNTIME_PLANNING_SYSTEM_SKILL = SystemSkillDefinition(
    ...
    prompt_instructions=(
        ...
        "Use `messages` only after sending a final user-facing report, answer, or summary through send_email, send_sms, or send_chat_message. Use the exact returned message_id UUID, or omit `messages`. Do not include routine progress updates, peer agent messages from send_agent_message, placeholders, SQL snippets, URLs, or invented IDs.\n"
