...
def _google_sheets_native_prompt_instructions(agent) -> str:
    ...
    return (
        ...
        "If `http_request` returns `native_integration_not_connected`, do not retry Google API calls; send the "
        "setup link through the current conversation channel and ask the user to connect Google Drive and choose "
        "the spreadsheet.\n"
