...
# These mutations can change which conditional static tools are available to the
# invoking agent during the current processing run.
META_GOBII_TOOL_NAMES_THAT_REFRESH_TOOLS = frozenset({
