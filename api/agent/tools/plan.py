    ...
    return {
        ...
        "function": {
            ...
            "description": (
                ...
                "Do not create or update a runtime plan just to preserve remaining batch work, record a resume "
                "cursor, or set a schedule; use the relevant result, SQLite config/queue update, or final message "
                "directly.\n"
