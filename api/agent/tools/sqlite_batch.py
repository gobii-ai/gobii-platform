    ...
    return {
        ...
        "function": {
            ...
            "description": (
                ...
                "Stable-key upsert: VALUES match columns/no WHERE; INSERT SELECT needs WHERE 1=1 before ON CONFLICT. "
                "group_concat(DISTINCT x) has no separator. Evolve normalized entities/relations; "
