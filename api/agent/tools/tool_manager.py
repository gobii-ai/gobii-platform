...
from .webhook_management import (
    MANAGE_INBOUND_WEBHOOKS_TOOL_NAME,
    MANAGE_OUTBOUND_WEBHOOKS_TOOL_NAME,
    execute_manage_inbound_webhooks,
    execute_manage_outbound_webhooks,
    get_manage_inbound_webhooks_tool,
    get_manage_outbound_webhooks_tool,
)
from .webhook_sender import SEND_WEBHOOK_EVENT_TOOL_NAME, execute_send_webhook_event, get_send_webhook_tool
...
BUILTIN_TOOL_REGISTRY = {
    ...
    MANAGE_INBOUND_WEBHOOKS_TOOL_NAME: {
        "definition": get_manage_inbound_webhooks_tool,
        "executor": execute_manage_inbound_webhooks,
        "search_hidden": True,
        "system_skill_key": WEBHOOKS_SYSTEM_SKILL_KEY,
    },
    MANAGE_OUTBOUND_WEBHOOKS_TOOL_NAME: {
        "definition": get_manage_outbound_webhooks_tool,
        "executor": execute_manage_outbound_webhooks,
        "search_hidden": True,
        "system_skill_key": WEBHOOKS_SYSTEM_SKILL_KEY,
    },
    SEND_WEBHOOK_EVENT_TOOL_NAME: {
        "definition": get_send_webhook_tool,
        "executor": execute_send_webhook_event,
        "search_hidden": True,
        "system_skill_key": WEBHOOKS_SYSTEM_SKILL_KEY,
    },
    **{
