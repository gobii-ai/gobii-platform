...
from .telegram_chats import (
    get_telegram_chats_tool,
    execute_telegram_chats,
)
from .send_telegram_message import (
    get_send_telegram_message_tool,
    execute_send_telegram_message,
)
from api.agent.system_skills.defaults import DISCORD_NATIVE_SYSTEM_SKILL_KEY, TELEGRAM_NATIVE_SYSTEM_SKILL_KEY
...
TELEGRAM_CHATS_TOOL_NAME = "telegram_chats"
TELEGRAM_SEND_MESSAGE_TOOL_NAME = "send_telegram_message"
...
BUILTIN_TOOL_REGISTRY = {
    ...
    TELEGRAM_CHATS_TOOL_NAME: {
        "definition": get_telegram_chats_tool,
        "executor": execute_telegram_chats,
        "search_hidden": True,
        "system_skill_key": TELEGRAM_NATIVE_SYSTEM_SKILL_KEY,
    },
    TELEGRAM_SEND_MESSAGE_TOOL_NAME: {
        "definition": get_send_telegram_message_tool,
        "executor": execute_send_telegram_message,
        "search_hidden": True,
        "system_skill_key": TELEGRAM_NATIVE_SYSTEM_SKILL_KEY,
    },
    **{
