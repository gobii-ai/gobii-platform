        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "will_continue_work": {
                        "type": "boolean",
                        "description": "REQUIRED. Set false to STOP when: all kanban cards are done AND you've sent your final report. Set true only if you have more work after updating charter. Omitting this wastes credits.",
                    },
                },
