    ...
    return {
        ...
        "function": {
            ...
            "description": (
                ...
                "Reports use styled metric blocks/tables, never plain metric lists."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "mobile_first_html": {
                        ...
                        "description": (
                            ...
                            "color:#312e81;padding:12px'><strong>32 scans</strong></div>`, then add styled tables or "
                            "metric blocks plus a badge such as `<span style='background:#fef3c7;padding:4px'>"
