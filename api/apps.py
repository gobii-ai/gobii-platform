...
class ApiConfig(AppConfig):
    ...
    def ready(self):
        ...
        try:
            from . import idle_notifications  # noqa: F401
        ...
        try:
            from .agent import peer_link_signals  # noqa: F401
        except Exception as e:  # pragma: no cover - optional dependency
            import logging
            logger = logging.getLogger(__name__)
        ...
        try:
            from .agent import collaborator_signals  # noqa: F401
        except Exception as e:  # pragma: no cover - optional dependency
            import logging
            logger = logging.getLogger(__name__)
        ...
        try:
            from . import system_setting_signals  # noqa: F401
        except ImportError as e:  # pragma: no cover - optional dependency
            import logging
            logger = logging.getLogger(__name__)
        ...
        try:
            from . import task_credit_signals
