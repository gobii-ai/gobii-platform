...
GOOGLE_SHEETS_NATIVE_CASES = (
    ...
    GoogleSheetsNativeCase(
        ...
        response_term_groups=(
            ...
            ("not found", "found nothing", "couldn't find", "could not find", "no matching", "no results", "no files", "not visible", "can't see", "could not locate", "empty", "zero files", "wasn't able to find"),
