...
class FirstRunPromptCalibrationTests(TestCase):
    ...
    def test_system_prompt_has_delivery_and_config_guardrails(self):
        ...
        self.assertIn("tool_call -> copy exact listed name/schema; never shorten or reconstruct", system_prompt)
        self.assertIn("Copy exact result URLs, paths, IDs", system_prompt)
