...
class ResponsibilityBoundaryScenarioTests(SimpleTestCase):
    def test_peer_contract_is_compact_and_ownership_first(self):
        ...
        self.assertIn("Completion/outcome events update owned records", instruction)
        self.assertIn("preserve provenance", instruction)
        self.assertIn("canonical entity by durable business identity", instruction)
