...
REMOVED_META_MESSAGE_TOOL_NAME = "meta_gobii_send_agent_message"
...
META_GOBII_NO_SCHEDULE_CASES = (
    MetaGobiiEvalCase(
        ...
        expect_skill=True,
        expect_skill_search=True,
        expected_tools=("meta_gobii_create_agent", "meta_gobii_link_agents", "send_agent_message"),
        expected_any_tools=("meta_gobii_get_agent_config_options", "meta_gobii_list_agents"),
        forbidden_tools=(LEGACY_SPAWN_TOOL_NAME,),
        expect_confirmation=True,
        expect_initial_proposal=True,
    ...
    MetaGobiiEvalCase(
        ...
        expect_skill=True,
        expect_skill_search=True,
        expected_tools=("meta_gobii_list_agent_links", "meta_gobii_link_agents", "send_agent_message"),
        expected_any_tools=("meta_gobii_list_agents", "meta_gobii_unlink_agents"),
        expect_confirmation=True,
    ),
    MetaGobiiEvalCase(
    ...
    MetaGobiiEvalCase(
        ...
        expect_skill=True,
        expect_skill_search=True,
        expected_tools=("meta_gobii_upload_agent_file", "meta_gobii_link_agents", "send_agent_message"),
...
def score_meta_gobii_case(
    ...
    *,
    ...
    forbidden_tools = (*case.forbidden_tools, REMOVED_META_MESSAGE_TOOL_NAME)
    forbidden_seen = [tool_name for tool_name in forbidden_tools if tool_name in ordered_tools]
