    ...
    try:
        ...
        try:
            ...
            AddonEntitlementService.sync_subscription_entitlements(
                ...
                created_via="console_quick_settings",
            )
        except Exception:
            logger.exception(
                "Failed to sync contact pack entitlements after quick settings update for %s",
...
def build_agent_quick_settings_payload(agent, owner=None, *, can_manage_billing: bool = False) -> dict:
